...
"""Unitree official G1 29-DoF velocity configuration (no dexterous hands).

Source: unitreerobotics/unitree_rl_lab at 4960b84732b0c2ec593dccbfe963fda1bcd7b1e3.
The asset assignment is copied unchanged. Only the unused URDF copy helper is
omitted from its spawn class. g1.py selects the upstream documented URDF option.
"""
