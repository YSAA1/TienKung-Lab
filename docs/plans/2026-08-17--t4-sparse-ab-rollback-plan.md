...
> 取代: `docs/plans/2026-08-15--t4-stepping-stones-and-hurdle-stable-plan.md` 的 S1d 执行面
> 被取代: `docs/plans/2026-08-17--t4-sparse-lightlp-complete-plan.md`（从零 + 收窄踏石 + 打破 sparse 1155D）
> Branch: `t4-train`
