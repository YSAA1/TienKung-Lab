...
| Unitree G1 越障 teacher | active：完整17段AMP，GPU0/2双卡正式训练30000轮、TB8038 | [机器人无关算法与现行训练](plans/2026-09-07--robot-neutral-locomotion.md) | 3303帧Isaac核验通过；保留T4原采样权重，每卡2048env；原对照停止，行为未验收 |
