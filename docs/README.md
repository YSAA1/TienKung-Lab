...
| Unitree G1 越障 teacher | active：全速A/B各双卡冷启动；A GPU0/2原路径晋级、B GPU1/3真实径向晋级；全17段、权重2、30000轮，TB8041 | [机器人无关算法与现行训练](plans/2026-09-07--robot-neutral-locomotion.md) | 稀疏速度0.6–2.0，不降速；恢复终止相同；旧两组停止留档，学习效果未验收 |
