...
| Unitree G1 越障 teacher | 核心修复及全部审核通过，单组B径向判据30k已冷启动，GPU0/2，TB8042；旧A/B已停止保留 | [核心修复计划与既有训练](plans/2026-09-07--robot-neutral-locomotion.md) | 六项明确逻辑缺陷、传感器缺失检查与依赖溯源；Actor速度合同保持，修复须过真实Isaac验收 |
