...
| Unitree G1 越障 teacher | active：GPU0/2原权重2基线；GPU1/3塌低恢复合同对照，权重2、全17段、30000轮；TB8040，旧权重4停止留档 | [机器人无关算法与现行训练](plans/2026-09-07--robot-neutral-locomotion.md) | 连续塌低.20s并服从impact immunity；真实probe/review通过，学习效果未验收 |
