...
已在nubot GPU0/2冷启动30k教师训练；原配方1000/2000/3000均未通过并已停训；当前为动作变化惩罚单变量候选，源码`7ca0c76`，等待新运行1000/2000/3000验收。
...
| Z2 29DoF 越障 teacher | 单变量候选训练中：源码`7ca0c76`，仅动作变化惩罚-0.1→-0.01；nubot GPU0/2、tmux `z2-actionrate-v1-20260909`；行为尚未验证 | [Z2 迁移](plans/2026-09-09--z2-teacher-migration.md) | 独立 spec，不复用 G1 形态或专家张量 |
