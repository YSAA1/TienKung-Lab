...
| Unitree G1 越障 teacher | active：v3 已冷启动 30k，统一 scale=0.5、AMP 输入/同步修复，GPU 0/2、TB 8032；原 AMP、10% 全 0～9。旧 v2 已停止 | [机器人无关算法整理与现行训练](plans/2026-09-07--robot-neutral-locomotion.md) | `legged_lab/locomotion` + 各机器人资产/spec；能力待评估 |
