...
| Unitree G1 越障 teacher | active：v6冷训练中，GPU1/3、TB8035；v4/v5已停止 | [机器人无关算法与现行训练](plans/2026-09-07--robot-neutral-locomotion.md) | 宇树官方纯29DoF，scale=0.25；c125f74修复自碰撞误终止；训练有效性未验收 |
