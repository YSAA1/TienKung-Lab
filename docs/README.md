...
| Unitree G1 越障 teacher | active：全17段AMP，GPU0/2权重2基线、GPU1/3权重4对照，均30000轮；合并TB8039 | [机器人无关算法与现行训练](plans/2026-09-07--robot-neutral-locomotion.md) | 每卡2048env、原AMP采样权重；配置单变量已核验，行为未验收 |
