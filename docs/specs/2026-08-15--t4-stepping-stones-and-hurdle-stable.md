...
> 货架: living 目标规格，但文中「T-compat / T-paper 双老师」已不是执行路线。现行执行：`docs/plans/2026-08-22--t4-sparse-s12-rim-yaw-student-plan.md`（S12 热启；sparse Actor 1937D，Stage E 1155D 不动）。
> Owner: user
> Date: 2026-08-15
