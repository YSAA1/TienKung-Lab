...
| Unitree G1 越障 teacher | active | 独立工作树 `TienKung-Lab-g1-portability-20260906`：AMP 终止快照、评估索引、动作尺度与速度课表已修，`portable_v1` 冷启动 10k；旧模型 flat 32/32、两类 easy sparse 0/32 | `docs/plans/2026-09-07--g1-teacher-portability.md` |
