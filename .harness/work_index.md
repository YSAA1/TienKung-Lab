...
| Unitree G1 越障 teacher | active / training + experiment | 核心修复B30000在GPU0/2、TB8042保持；新增VITAL起步配方实验使用GPU1/3，保留LightLP奖励，仅改动作变化惩罚、终止和步态门控；真实双卡检查通过，启动信息见实验工件 | `docs/plans/2026-09-07--robot-neutral-locomotion.md` |
