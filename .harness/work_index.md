...
| Unitree G1 越障 teacher | active | 官方纯29DoF v6，c125f74，GPU1/3各2048env，30k冷启动，TB8035；T4早期固定评估已完成，待G1 model_500对照；训练有效性目标未完成 | `docs/plans/2026-09-07--robot-neutral-locomotion.md` |
