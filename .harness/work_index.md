...
| --- | --- | --- | --- |
| Z2 29DoF teacher | active / formal VITAL training | d6bef33；nubot `TienKung-Lab-z2-vital-20260909`；GPU0/2；三项配置实际生效；不再逐项对比 | `docs/plans/2026-09-09--z2-teacher-migration.md`；`artifacts/z2_migration/vital_formal_v1/lineage.json` |
