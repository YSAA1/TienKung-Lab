...
| Unitree G1 越障 teacher | active | v3 已冷启动 30k，统一 scale=0.5，修复 AMP 输入/多卡同步，GPU 0/2、TB 8032；原 AMP、10% 全 0～9。旧 v2 已按用户要求在 9662 轮停止 | `docs/plans/2026-09-07--robot-neutral-locomotion.md` |
