...
| Unitree G1 越障 teacher | active / training | F1-F6/R1-R2、173项CPU、真实单卡/双卡及独立审核通过。单组B径向判据30k已冷启动，GPU0/2，TB8042；旧A/B已停止，20个checkpoint及历史保留 | `docs/plans/2026-09-07--robot-neutral-locomotion.md` |
