...
| Unitree G1 越障 teacher | active | 全17段AMP；GPU0/2原权重2基线、GPU1/3塌低恢复合同对照（仍权重2）；双卡30000轮，TB8040；旧权重4停止留档，学习效果待验收 | `docs/plans/2026-09-07--robot-neutral-locomotion.md` |
