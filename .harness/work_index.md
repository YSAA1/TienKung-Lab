...
| Unitree G1 越障 teacher | active | T4→G1 rob2rob数据对照18:18已放行；GPU0旧数据/零速基线，GPU2新数据，各2048env/4000轮，TB8037；随机初速组停止，v6 GPU1/3继续参照；行为未验收 | `docs/plans/2026-09-07--robot-neutral-locomotion.md` |
