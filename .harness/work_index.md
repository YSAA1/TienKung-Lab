...
| Unitree G1 越障 teacher | active | 全速A/B：GPU0/2原路径晋级、GPU1/3真实径向晋级；两组同recovery终止、全17段、权重2、各双卡30000轮；TB8041，旧两组停止留档 | `docs/plans/2026-09-07--robot-neutral-locomotion.md` |
