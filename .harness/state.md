...
- Running lineage: `stage_e_prov4`，从 `stage_e_prov3` 的 `model_2000.pt` 续训，nubot tmux `t4-stage-e`，commit `bf06c0a`，4x RTX 4090，每卡 1024 env，剩余预算 38000 iter（接到 40000），日志 `logs/t4-stage-e-teacher.log`。
