...
set -uo pipefail
cd /home/nubot/phn_ws/t4_train/TienKung-Lab-z2-vital-20260909 || exit 90
...
bash scripts/nubot_run.sh -m torch.distributed.run --nproc_per_node=2 --master_port=29656 \
  ...
  --experiment_name z2_loco_teacher_sparse --run_name z2_vital_formal_v1 \
