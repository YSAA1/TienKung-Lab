...
def train():
    ...
    log_root_path = "/tmp/g1_teacher_audit_20260907/amp_fix_probe"
    ...
    Path("/tmp/g1_teacher_audit_20260907/amp_fix_runtime_rank%d.json" % dist.get_rank()).write_text(json.dumps(result, indent=2)+"\n")
